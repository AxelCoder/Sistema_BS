			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Pago de transporte</h5>
						...
						<form action="#">
							<fieldset class="mb-3">
                                ...
                                <div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" value="1930204">
									</div>
								</div>
								...
								<div class="form-group">
										<label class="col-form-label col-lg-2">Carreras</label>
										<select name="combo">
								...
								<div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="format-date" value="25/10/2019">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="combo">
                                        <optgroup label="Rutas disponibles">
                                                <option value="CO">Ruta 4</option>
                                                <option value="ID">Ruta 8</option>
                                            <option value="ID">Ruta 10</option>
                                            <option value="AZ">Ruta 16</option>
                                        </optgroup>
                                    </select>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <select name="combo">
                                        <optgroup label="Horario">
                                            <option value="ID">7:00am a 2:00pm</option>
                                            <option value="AZ">12:00pm a 2:00pm</option>
                                            <option value="CO">12:30pm a 4:30pm</option>
                                            <option value="ID">12:00pm a 2:00pm</option>
                                            <option value="WY">11:00am a 1:00pm</option>
                                        </optgroup>
                                    </select>
                                </div>
